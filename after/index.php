    ...
    <div class="container new_container">
      ...
      <div class="list-menu">
        <ul>
          ...
          <li> <span class="btn-span"><a href="./about.html"><span>About Us</span></a></span> </li>
    ...
    <div class="containercontact">
      ...
      if (isset($_REQUEST['method'])) {
        ...
        if($paymentmethod !='paypal'){
            $orderstatus = 'Your payment was successful.';
          }else{
            $orderstatus = 'Your payment was pending';
          }
        ...
        $message = "<html>
                                ...
                                <p> Order Status is = " . $orderstatus . "</p>
        ...
        <?php }elseif(isset($_REQUEST['method']) && $_REQUEST['method'] == 'paypal'){ ?>
         <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <tr><td><input type="hidden" name="on0" value="service">service</td></tr><tr><td><select name="os0">
              <option value="Option 1" <?php echo ($_POST['delivery_option']=='6.99') ? 'selected="selected"' : ''; ?>>Option 1 £6.99 GBP</option>
              <option value="Option 2" <?php echo ($_POST['delivery_option']=='6.99') ? 'selected="selected"' : ''; ?>>Option 2 £6.99 GBP</option>
              <option value="Option 3" <?php echo ($_POST['delivery_option']=='7.99') ? 'selected="selected"' : ''; ?>>Option 3 £7.99 GBP</option>
            </select> </td></tr>
            </table>
            <input type="hidden" name="encrypted" value="-----BEGIN PKCS7----------END PKCS7-----">
        ...
        <form name="message" method="post" id="payment-form" enctype="multipart/form-data">
          <div class="help-bg-home">
              <div class="form-group">
                ...
                <select name="delivery_option" required class="form-control" onChange="setChageVal(this.value);">
                  <option value="">Choose an option</option>
                  <option value="6.99">HMRC passport photo code £6.99 (Uk Only)</option>
                  <option value="6.99">Six printed passport photos send to your address £6.99 (Uk Only)</option>
             ...
             <!--   <label for="delivery_option">Delivery Option <span class="required">*</span></label><br>
                ...
                <div class="input-group mb-3 display_block payment_method_list" style="margin-top: 5px;">
                  <div class="form-check">
                    <input type="radio" id="stripe_method" name="method" value="stripe" checked required>
                ...
                <p style="display:none;" id="selectedValue_p" >You will get charged £<span id="selectedValue"></span> for delivery.</p>
                ...
                <div class="stripe_method">
                  <div class="row g-3">
                    ...
                    <div class="col-md-4 ">
                        <label class="form-label">Card Number <img class="cards" src="images/cards.png" alt="Cards" /></label>
