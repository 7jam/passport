...
if ($_FILES['avatar']) {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, [
        ...
        'image_url' => 'https://hounslowpassportphotoshop.co.uk/v3/uploads/' . $avatar,
    ...
    if ($content === FALSE) {
        ...
        if ($httpcode == 200) {
            ...
            echo 'https://hounslowpassportphotoshop.co.uk/v3/uploads/rm-' . $avatar;

        } else {

            echo 'https://hounslowpassportphotoshop.co.uk/v3/uploads/' . $avatar;

        }

        $_SESSION['rmPhoto'] = 'https://hounslowpassportphotoshop.co.uk/v3/uploads/rm-' . $avatar;

        $_SESSION['ogPhoto'] = 'https://hounslowpassportphotoshop.co.uk/v3/uploads/' . $avatar;
