...
<body>
    <div class="whole">
            ...
            <div class="banner_left">
                <header>
                    <div class="header-bg">
                        <div class="header-left">
                            <div class="desktop">
                                <div class="logo">
                                    <a class="site-logo_home" href="https://hounslowpassportphotoshop.co.uk/v3/">
                ...
                <section>
                    ...
                    <div class="passport_img">
                        <img src="images/passport_img.png" alt="Passport" />
                    </div>
                </section>
            </div>
            <div class="banner_right">
                <div class="passport-bg">
                    ...
                    <div class="address_info">
                        <div class="adddress_info_list">
                            <img src="images/location_icon.png">
                            <span>756F bath Rd Cranford Middlesex TW5 TY Hounslow</span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/mail_icon2.png">
                            <span><a
                                    href="mailto:contact@hounslowpassportphotoshop.co.uk">contact@hounslowpassportphotoshop.co.uk</a></span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/phone_icon.png">
                            <span><a href="tel:02087593688">02087593688</a> , <a
                                    href="tel:07553949353">07553949353</a></span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/globe_icon2.png">
                            <span><a
                                    href="https://hounslowpassportphotoshop.co.uk/">www.hounslowpassportphotoshop.co.uk</a></span>
                        </div>
                    </div>
                </div>
                <div class="british-passport">
                    <img src="images/passpot_copy.png" alt="">
                </div>
            </div>
        </div>
        <!-- <div class="new_banner_bg">
      <img src="images/banner.jpg" alt="Banner" />
    </div> -->
        <div class="container new_container">
            <!-- <div class="address_info">
        <img src="images/address_info.png" alt="Address" />
      </div> -->
            <div class="list-menu">
                <ul>
                    <li> <span class="btn-span active"><a href="./"><span>Home</span></a></span> </li>
                    <li> <span class="btn-span"><a href="./british-passport-photo.php"><span>British Passport
                                    Photo</span></a></span> </li>
                    <!-- <li> <span class="btn-span"><a href="./hmrc-photo.php"><span>HMRC Photo Code</span></a></span> </li> -->
                    <li> <span class="btn-span"><a href="./worldwide-passport-photo.php"><span>Worldwide Passport
                                    Photo</span></a></span> </li>
                    <li> <span class="btn-span"><a href="./about.php"><span>About Us</span></a></span> </li>
                    <li> <span class="btn-span"><a href="./contact.php"><span>Contact Us</span></a></span> </li>
            ...
            <div class="container">
                ...
                <div>
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/-GuYWXKioi0" title="YouTube video"
      ...
      if (isset($_REQUEST['method'])) {
        ...
        if($paymentmethod !='paypal'){
            $paymentmethods = 'Credit/Debit Card (Power by Stripe)';
          }else{
        ...
        $message = "<html>
                                ...
                                <body>
                                <p> Payment  Status = " . $orderstatus . "</p>
                                <p> Payment Method = " . $paymentmethods . "</p>
                                <p> Name = " . $_POST['name'] . "</p>
                                ...
                                <p> Your Delivery Price is = £" . $_POST['delivery_option'] . "</p>
                                </body>
                                </html>";
        ...
        $mail->AddCC('contact@hounslowpassportphotoshop.co.uk');
        ...
        if(isset($_REQUEST['method']) && $_REQUEST['method'] == 'stripe' && $_POST["stripeToken"]){ 

          \Stripe\Stripe::setApiKey("sk_test_51LD400D9tDbBUl5C0NnILajnqx7IQiJ9qvesVBSuJXFOoC81lNhntljS4xS2ODKytWg1u7hmVCrxRJYtbOKzBuHh00UHmNfgBw");
          $error = '';
          $success = '';
          ...
          ?>
            ...
            <!-- <script>window.location.href="https://buy.stripe.com/test_28oaIkez58Av7x6cMM";</script>-->
            <?php }elseif(isset($_REQUEST['method']) && $_REQUEST['method'] == 'paypal'){ ?>
            <form action="https://www.paypal.com/cgi-bin/webscr" id="paypal_form" method="post">
                ...
                <input type="hidden" name="amount" value="<?php echo $_POST['delivery_option'];?>">
                <input type="hidden" name="business" value="royalproductphotography@gmail.com">
                <INPUT TYPE="hidden" NAME="currency_code" value="GBP">
                <INPUT TYPE="hidden" NAME="return"
                    value="https://hounslowpassportphotoshop.co.uk/v3/?message=paymentsucess">
                <input type="submit" id="paypal_form_submit" style="opacity: 0;" name="submit"
                    alt="PayPal - The safer, easier way to pay online">
                <input type="hidden" name="first_name" value="<?php echo $_POST['name'];?>">
                ...
                <input type="hidden" name="state" value="<?php echo $_POST['region'];?>">
                <input type="hidden" name="zip" value="<?php echo $_POST['postcode'];?>">
                <input type="hidden" name="country" value="<?php echo $_POST['selCountry'];?>">
                <input type="hidden" name="night_phone_a" value="<?php echo $_POST['phone'];?>">
      ...
      ?>
            ...
            $(document).ready(function() {
                setTimeout(function() {
                    $('.payment-success').fadeOut('fast');
                }, 5000);
            });

            function setChageVal(charge) {
                $('#selectedValue').html(charge);
                $('#selectedValue_p').show();
            }
            </script>
            <?php 
      if($_GET['message']=='paymentsucess'){?>
      ...
      ?>
            ...
            <section class="inner-box-1 step1">
                ...
                <form name="message" method="post" id="payment-form" enctype="multipart/form-data">
                    <div class="help-bg-home">
                        <div class="form-group">
                            <label class="delivery_option_title">Delivery Option <span class="required">*</span></label>
                            <select name="delivery_option" required class="form-control"
                                onChange="setChageVal(this.value);">
                                <option value="">Choose an option</option>
                                <option value="6.99">HMRC passport photo code £6.99 (Uk Only)</option>
                                <option value="6.99">Six printed passport photos send to your address £6.99 (Uk Only)
                                </option>
                                <option value="7.99">Passport digital photo send to email £7.99 (Worldwide)</option>
                            </select>
                        </div>
                        <div class="help-left">
                ...
                <input type="button" id="btnRestore" value="Restore" /> -->
                            <div class="input-group pt-2">
                                <input type="file" class="form-control widthcust" name="file" id="fileInput"
                                    accept="image/*">
                            ...
                            <select
                                ...
                                id="selDocType" name="selDocType" class="form-control"></select>
                            ...
                            <label
                                onchange="document.getElementById('text_content').value=document.getElementById('selDocType').options[document.getElementById('selDocType').selectedIndex].text"
                                for="postcode">Postcode <span class="required">*</span></label>
                ...
                <div class="input-group mb-3 display_block" style="margin-top: 5px;">
                  ...
                  <label for="send_to_mail" class="radiobtn">Passport digital photo send to email <span class="price">£7.99</span>(Worldwide)</label><br>
                </div> -->

                            <label for="payment_method">Payment Method <span class="required">*</span></label><br>
                            <div class="input-group mb-3 display_block payment_method_list" style="margin-top: 5px;">
                                <div class="form-check">
                                    <input type="radio" id="stripe_method" name="method" value="stripe" checked
                                        required>
                                    <label for="stripe_method" class="radiobtn">Stripe</label><br>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="paypal_method" name="method" value="paypal" required>
                                    <label for="paypal_method" class="radiobtn">Paypal</label>
                                </div>

                            </div>
                            <p style="display:none;" id="selectedValue_p">You will get charged £<span
                                    id="selectedValue"></span> for delivery.</p>
                            <div id="paymentResponse" style="display:none;"></div>
                            <!-- <span class="payment-errors"><?= $error ?></span>
                 <span class="payment-success"><?= $success ?></span>-->
                            <div class="stripe_method">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 ">
                                        <label class="form-label">Card Number <img class="cards" src="images/cards.png"
                                                alt="Cards" /></label>
                                        <div id="card_number" class="card_field card-number"></div>
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label">Expires:</label>
                                        <div id="card_expiry" class="card_field card-expiry"></div>
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label">CVV</label>
                                        <div id="card_cvc" class="card_field card-cvc"></div>
                                    </div>

                                </div>
                            </div>
                            <div class="paypal_method" style="display: none;">
                                <img src="images/paypal.png?ver=<?php echo time();?>" alt="Paypal" />
                                <span>You will redirect on Paypal.</span>
                            </div>
                            <input id="send" name="btnsubmit" type="submit" value="Submit" class="submit-button">
            ...
            var stripe = Stripe('pk_test_51LD400D9tDbBUl5Cl82jL2IbaM7W4PvOUreI6yzU1exWGixdpEx8nky0KLUV96WyfNKZMLnVPS9lYuU2ssU8QDLj00TEjdZtt7');
            //Stripe.setPublishableKey('pk_test_oTruSCZTRDEeYT4vlRt529vG');
            ...
            $(document).ready(function() {
                $("#payment-form").submit(function(event) {
                    ...
                    stripe.createToken({
                        ...
                        cvc: $('.card-cvc').val(),
                        exp_month_year: $('.card-expiry').val()
        ...
        <section class="inner-box-1 showon1 photo_upload_info">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img1.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">You uploaded the photo</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img2.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">You used online apps</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img3.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">You sent the photo to us we fixed!</h5>
                        </div>
                    </div>
                </div>
        ...
        <section class="passport_photo">
            <div class="inner-box-1">
                <div class="professional-bg">
                    <h2>Remove Background from Passport Photo</h2>
                    <span>Powerful Background Remover</span>
                    <div class="edit_productimg">
                        <label>To Edit Your passport photo</label>
                        <a href="https://www.pixelbrandstudio.com/upload">
                            Click Here
                            <!-- <button class="btnhref">Remove your passport photo background automatically 
                  <img src="images/3d_arrows.gif" alt="" />
                </button> -->
                        </a>
                    </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="accordion-body">
                                If your phone has a camera capable of producing clear photos, use it to take a snap and
                                upload it to the Hounslow Photo Studio website.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                2. What kind of information will I be required to provide when applying for Hounslow
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                The Hounslow Photography studio website has a form which your name, email address, phone
                                number, town/city of residence, and postcode before using the service.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingfour">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                4. Can Hounslow photography studio really provide a quick and reliable solution for my
                                passport photo needs?
                            </button>
                        </h2>
                        <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Yes. Our services save you from having to use non-professional applications that often
                                result in low-quality passport photographs.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapsefive" class="accordion-collapse collapse" aria-labelledby="headingfive"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Once the passport photos are ready, we send an email to our client with an invoice and
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseseven" class="accordion-collapse collapse" aria-labelledby="headingseven"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                We aim to deliver as fast as possible for additional customer satisfaction. We have
                                next-day delivery once payment is made.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                We will deliver 6 printed copies of your passport photo to your doorstep. We will also
                                provide you with a digital copy which will be sent through email.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="collapse9" class="accordion-collapse collapse" aria-labelledby="heading9"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                We will also send the HMRC code which will guarantee that your passport photo will not
                                be rejected.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapse11" class="accordion-collapse collapse" aria-labelledby="heading11"
                            data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                We use pro software which ensures that your passport photos will not be rejected by
                                HMRC.
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $(".payment_method_list  input[name='method']").click(function() {
        if ($("#stripe_method").is(":checked")) {
            $(".stripe_method").show();
            $(".paypal_method").hide();
        } else {
            $(".stripe_method").hide();
...
var stripe = Stripe(
    'pk_test_51LD400D9tDbBUl5Cl82jL2IbaM7W4PvOUreI6yzU1exWGixdpEx8nky0KLUV96WyfNKZMLnVPS9lYuU2ssU8QDLj00TEjdZtt7');
...
form.addEventListener('submit', function(e) {
    ...
    e.preventDefault();
    var payment_method = jQuery('input[name="method"]:checked').val();
